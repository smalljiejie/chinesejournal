...
\cjcsetup{
  ...
  name         = {作者},
  name*        = {NAME},
  affilname    = {学校 学院, 市 国 邮编},
  affilname*   = {Department of ****, University, code, Country},
  abstract     = {摘要},
...
\begin{thebibliography}{99}
  ...
  \bibitem{wy}Wang W, Sun Y, Li H, Han Z. Cross-layer attack and defense in cognitive radio networks//Proceedings of the IEEE Globe Communication Conference (Globecom) 2010. Miami, Florida, USA,2010:1-6
  \bibitem{wf}Barbour N, Schmidt G. Inertial sensor technology trends. IEEE Sensors Journal,2011,1(4):332- 339
  \end{thebibliography}
